    ...
    try {
      ...
      if (success) {
        toast({
          ...
          description: 'Welcome to ShopWave! You can now log in.',
        });
        router.push('/login'); // Redirect to login after successful signup
      } else {
        throw new Error("Sign up failed. Please try again."); // Mock error
      }
    } catch (error: any) {
      toast({
    ...
    <Card className="w-full max-w-md shadow-xl">
      <CardHeader>
        ...
        <CardDescription className="text-center">
          Join ShopWave today and start discovering amazing products!
        </CardDescription>
      </CardHeader>
      <CardContent>
        <Form {...form}>
